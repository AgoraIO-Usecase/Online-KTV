...
JNIEXPORT jstring
JNICALL
Java_com_example_zhanxiaochao_agoraplayerdemo_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_example_zhanxiaochao_agoraplayerdemo_MainActivity_Open(JNIEnv *env, jobject instance,
                                                                jstring url_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_zhanxiaochao_agoraplayerdemo_XPlay_InitView(JNIEnv *env, jobject instance,
                                                             jobject surface) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_zhanxiaochao_agoraplayerdemo_MainActivity_PlayOrPause(JNIEnv *env,
                                                                      jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_example_zhanxiaochao_agoraplayerdemo_MainActivity_setCallBack(JNIEnv *env,
                                                                       jobject instance) {
    env->GetJavaVM(&gJVM);
    // TODO
    if (gCallBack == nullptr) {
        gCallBack = env->NewGlobalRef(instance);
        gCallbackClass = env->FindClass("com/example/zhanxiaochao/agoraplayerdemo/MainActivity");
